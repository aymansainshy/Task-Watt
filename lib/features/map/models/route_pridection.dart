...
RoutePredictionResponse predictionResponseFromJson(String str) => RoutePredictionResponse.fromJson(json.decode(str));

String predictionResponseToJson(RoutePredictionResponse data) => json.encode(data.toJson());

class RoutePredictionResponse {
  ...
  factory RoutePredictionResponse.fromJson(Map<String, dynamic> json) => RoutePredictionResponse(
